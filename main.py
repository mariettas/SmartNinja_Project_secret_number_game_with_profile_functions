...
def login():
    ...
    if hashed_password != user.password:
        ...
        session_token = str(uuid.uuid4())  # create a random session token for this user
        User.edit(obj_id=user.id, session_token=session_token)  # save the session token in a database
